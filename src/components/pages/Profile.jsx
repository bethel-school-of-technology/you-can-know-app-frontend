...
const Profile = ({ history }) => {
	...
	useEffect(() => {
		...
		axios.get(baseUrl + '/profile', { headers: ykHeader }).then(currentUser => {
	...
	// const baseUrl = 'http://localhost:3002/userPost';
	...
	// 		authorization: "Bearer " + localStorage.getItem("ykToken")
	// 	}
	// 	axios.get(baseUrl + '/posts', { headers: ykHeader }).then(Posts => {
	// 		console.log(Posts);
	// 		// setUsername(currentUser.data.user.Username)
	// 		// // setUserId(currentUser.data.user.UserId)
	// 		// setFirstName(currentUser.data.user.FirstName)
	...
	// 		// setPic(currentUser.data.user.Pic)
	// 		// setpicMessage(currentUser.data.user.picMessage)
	// 		setPostTitle(Posts.data.Posts.PostTitle)
	// 		setPostBody(Posts.data.Posts.PostBody)
	// 		setPostId(Posts.data.Posts.PostId)
	// 	});
