...
const Mexico = ({ history }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-mexico-img bg-fixed bg-cover py-12 px-4 sm:px-6 lg:px-8">
      <div>
        <div className="mx-auto max-w-2xl   bg-red-800 bg-opacity-80  mt-16 pt-6 py-4 px-4 rounded-lg border-4 border-white">
          {" "}
          <div className="container mx-auto px-4 mb-16 h-auto object-center ">
            <div className="max-w-md w-full space-y-8 mt-16 bg-white bg-opacity-90 px-10 pb-6 pt-4 rounded-lg border-4 border-white">
