...
function About() {
  return (
    <>
    <section className="min-h-screen flex items-center justify-center bg-fixed bg-about-img bg-cover py-16 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto px-4 mb-15 h-auto object-center ">
        <div className="flex flex-wrap justify-center mt-16  bg-white bg-opacity-90 px-6 pb-6 rounded-lg border-4 border-white">
          <div className="bg-white pb-6 pt-4 mt-6 rounded-lg">
            <h2 className="text-3xl text-center font-extrabold text-red-700">
              You Can Know the Creators
            </h2>
            <p className="text-lg leading-relaxed m-4 text-blueGray-500 text-center">
              These three people have two things in common: Full Stack Web
              Development and a love for travel. Together, they did exactly
              that...they joined these two passions together and created the
              perfect app for traveling secrets. It's a must-have for those of
              you that love to see the world!
            </p>
          </div>
              ...
              <div className="pt-6 text-center">
                ...
                <div className="mt-6">
                  <button
                    ...
                    type="button"
                  >
                    <a href="https://github.com/ASherry28/" target="_blank">
                  ...
                  <button
                    ...
                    type="button"
                  >
                    <a href="https://www.linkedin.com/in/ashley-sherry777/" target="_blank">
              ...
              <div className="pt-6 text-center">
                ...
                <div className="mt-6">
                  <button
                    ...
                    type="button"
                  >
                    <a href="https://github.com/manuel-urbina" target="_blank">
                    <img src={image5} alt="github" />
                    </a>
                  </button>
                  <button
                    ...
                    type="button"
                  >
                    <a href="https://www.linkedin.com/in/manuel-urbina/" target="_blank">
                    <img src={image6} alt="linkedin" />
                    </a>
                  </button>
                </div>
              ...
              <div className="pt-6 text-center">
                ...
                <div className="mt-6">
                  <button
                    ...
                    type="button"
                  >
                    <a href="https://github.com/joegartman" target="_blank">
                    <img src={image5} alt="github" />
                    </a>
                  </button>
                  <button
                    ...
                    type="button"
                  >
                    <a href="https://www.linkedin.com/in/joegartman/" target="_blank">
                    <img src={image6} alt="linkedin" />
                    </a>
                  </button>
                </div>
