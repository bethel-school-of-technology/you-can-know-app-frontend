  ...
  return (
    <section className="bg-white text-3xl text-black text-center font-extrabold pt-28">
      ...
      <p className="font-normal text-base text-left mt-6 px-14">
        ...
        <h1 className="text-left font-bold mt-5">WEBSITE DISCLAIMER</h1>
        <p className="mt-5">
          The information provided by You Can Know (“Company”, “we”, “our”,
          “us”) on www.youcanknow.com (the “Site”) is for general informational
        ...
        <h1 className="text-left font-bold mt-5">EXTERNAL LINKS DISCLAIMER</h1>
        <p className="mt-5">
          ...
          sample Disclaimer template for a website, blog, eCommerce store or
          ...
          THIRD-PARTY WEBSITES LINKED THROUGH THE SITE OR ANY WEBSITE OR FEATURE
          LINKED IN ANY BANNER OR OTHER ADVERTISING. WE WILL NOT BE A PARTY TO
          OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN
          YOU AND THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES.
        </p>
        <h1 className="text-left font-bold mt-5">TESTIMONIALS DISCLAIMER</h1>
        <p className="mt-5">
          ...
          INDIVIDUAL RESULTS MAY VARY. The testimonials on the Site are
          ...
          not relevant to the general public. The views and opinions contained
          in the testimonials belong solely to the individual user and do not
        ...
        <p className="mt-5">
          ...
          contained in this site has been obtained from reliable sources, You
          Can Know is not responsible for any errors or omissions or for the
          ...
          will You Can Know, its related partnerships or corporations, or the
          ...
          in this Site or for any consequential, special or similar damages,
        ...
        <p className="mt-5">
          ...
          those of You Can Know or any of its staff or affiliates unless
          explicitly stated.
        </p>
        <h1 className="text-left font-bold mt-5">
        ...
        <p className="mt-5">
          ...
          www.youcanknow.com are the trademarks and logos of their respective
          owners. Any inclusion of such trademarks or logos does not imply or
          constitute any approval, endorsement or sponsorship of You Can Know by
          such owners.
        </p>
        <h1 className="text-left font-bold mt-5">CONTACT US</h1>
        <p className="mt-5 mb-10">
          Should you have any feedback, comments, requests for technical support
          or other inquiries, please contact us by email: youcanknow@gmail.com.
        </p>
      </p>
    </section>
  );
