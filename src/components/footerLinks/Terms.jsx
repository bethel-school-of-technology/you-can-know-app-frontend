...
function Terms() {
  return (
    <section className="bg-white text-3xl text-black text-center font-extrabold pt-28">
      <h1>TERMS AND CONDITIONS</h1>
      <p className="font-normal text-base text-left mt-6 px-14">
        <p className="mt-5">Last updated: 2021-09-28</p>
        <h1 className="text-left font-bold mt-5">1. Introduction</h1>
        <p className="mt-5">
          Welcome to You Can Know (“Company”, “we”, “our”, “us”)! These Terms of
          Service (“Terms”, “Terms of Service”) govern your use of our website
          located at www.youcanknow.com (together or individually “Service”)
          operated by You Can Know. Our Privacy Policy also governs your use of
          ...
          but please let us know by emailing at youcanknow@gmail.com so we can
          try to find a solution. These Terms apply to all visitors, users and
          others who wish to access or use Service.
        </p>

        <h1 className="text-left font-bold mt-5">2. Communications</h1>
        <p className="mt-5">
        ...
        <h1 className="text-left font-bold mt-5">4. Content</h1>
        <p className="mt-5">
          ...
          Terms. You Can Know has the right but not the obligation to monitor
          and edit all Content provided by users. In addition, Content found on
          or through this Service are the property of You Can Know or used with
        ...
        <h1 className="text-left font-bold mt-5">5. Prohibited Uses</h1>
        <p className="mt-5">
        ...
        <h1 className="text-left font-bold mt-5">6. Analytics</h1>
        <p className="mt-5">
          We may use third-party Service Providers to monitor and analyze the
          use of our Service.
        </p>
        <h1 className="text-left font-bold mt-5">7. No Use By Minors</h1>
        <p className="mt-5">
        ...
        <h1 className="text-left font-bold mt-5">8. Accounts</h1>
        <p className="mt-5">
        ...
        <h1 className="text-left font-bold mt-5">9. Intellectual Property</h1>
        <p className="mt-5">
          Service and its original content (excluding Content provided by
          users), features and functionality are and will remain the exclusive
          property of You Can Know and its licensors. Service is protected by
          ...
          without the prior written consent of You Can Know.
        </p>
        <h1 className="text-left font-bold mt-5">10. Copyright Policy</h1>
        <p className="mt-5">
          ...
          youcanknow@gmail.com, with the subject line: “Copyright Infringement”
        ...
        <p className="mt-5">
          ...
          contact our Copyright Agent via email at youcanknow@gmail.com.
        </p>
        <h1 className="text-left font-bold mt-5">
          12. Error Reporting and Feedback
        </h1>
        <p className="mt-5">
          You may provide us either directly at youcanknow@gmail.com or via
        ...
        <p className="mt-5">
          ...
          that are not owned or controlled by You Can Know. You Can Know has no
          ...
          created using PolicyMaker.io, a free web application for generating
          ...
          store or app. YOU ACKNOWLEDGE AND AGREE THAT COMPANY SHALL NOT BE
        ...
        <h1 className="text-left font-bold mt-5">14. Disclaimer Of Warranty</h1>
        <p className="mt-5">
        ...
        <h1 className="text-left font-bold mt-5">16. Termination</h1>
        <p className="mt-5">
        ...
        <h1 className="text-left font-bold mt-5">17. Contact Us</h1>
        <p className="mt-5">
          Please send your feedback, comments, requests for technical support by
          email: youcanknow@gmail.com.
        </p>
        <p className="mt-5 mb-10">
          These Terms of Service were created for www.youcanknow.com by
          PolicyMaker.io on 2021-09-28.
        </p>
      </p>
    </section>
  );
